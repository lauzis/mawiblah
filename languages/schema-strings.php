...
__( 'Background Send (WP Cron)', 'mawiblah' );
__( 'Can disable actual email sending', 'mawiblah' );
__( 'Disabled', 'mawiblah' );
__( 'Dont disturb threshold', 'mawiblah' );
...
__( 'Optional Google reCAPTCHA v3 protection for the subscription form. Leave disabled to rely on honeypot only. Get your keys at https://www.google.com/recaptcha/admin/', 'mawiblah' );
__( 'Restrict output by ip (comma separated)', 'mawiblah' );
__( 'Scheduler', 'mawiblah' );
...
__( 'reCAPTCHA v3 (Subscription Form)', 'mawiblah' );
