            ...
            <table class="wp-list-table widefat fixed striped" style="max-width:800px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php esc_html_e('Disabled by default. Set to "Enable DB log" to activate file-based logging — entries are written to daily files at {uploads}/mawiblah/logs-{random}/mawiblah-YYYY-MM-DD.log. Use the Actions page to view and clear log files.', 'mawiblah'); ?></td>
                    </tr>
                    <tr>
